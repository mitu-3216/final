...
#break
 ...
 for port in range(port_min, port_max + 1):
  ...
  st.write("\n\n----------------Solution---------------\n\n")
  st.write("Most important ports are 20,21,23,25,53,80,67,68,110,161,162,389,443,179.If this ports are open then Youneed to first secure this ports. For port 20 and 21 you need to use Secure FTP, port 23 Secure Shell(SSH), port 25 and 110 Forsed authentication, port 53 DNSSEC, port 80 HTTPS, port 161,162 SNMPv3, port 5060 SIPS.")
